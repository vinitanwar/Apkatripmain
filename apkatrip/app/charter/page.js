...
const handelcruiseMessage = async(e)=>{
 e.preventDefault();
 const res=await axios.post(`${apilink}/charter`,{...alldata,request_date:new Date(Date.now())})
if(res.data.success){
       ...
       <div className=" h-full   w-full flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between relative z-10">
         <div className=" lg:w-1/2 space-y-4 ">
           <h5 className="font-extrabold  lg:leading-tight text-2xl md:text-3xl lg:text-4xl  text-white ">
             Travel in Style Luxury Charter  for Every Explorer
           </h5>
           <p className="text-white">
             Embark on a journey of a lifetime aboard a luxury charter , where
       ...
       <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 p-4 md:p-8">
         ...
         <div className="w-full space-y-6 md:space-y-10 text-center md:text-left">
           <h4 className="font-bold text-xl md:text-2xl lg:text-3xl text-[#42A6EF]">
             Benefits of Choosing Apka Trip for Your Charter 
           </h4>
           <p className="text-gray-700 text-sm md:text-base lg:text-lg leading-relaxed">
             Experience seamless planning, exclusive deals, and personalized
             service with Apka Trip. We ensure your charter vacation is
       ...
       <div className="startHere ">
         <div className="text-center xl:w-[70%] mx-auto space-y-5">
           <h6 className="text-xl font-semibold">
             Start Your Next Charter Exploration Heree
           </h6>
           <p>
             Plan your next charter with our expert guide to affordable trips
             across Europe, Asia, the Mediterranean, and the Caribbean,
             providing the best options for an unforgettable charter adventure.
           </p>
         </div>
       ...
       <section className="details space-y-5 py-10 ">
         <div className="text-center">
           <h2 className="text-2xl  font-extrabold leading-tight ">
             Charter Adventures for Every Explorer
           </h2>
           <p>
             Embark on a charter journey like no other. From tropical islands to
             majestic glaciers, our luxury charters offer something for every
             type of traveler.
           </p>
         </div>
