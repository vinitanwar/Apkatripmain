      ...
      <div className="block md:flex px-0 lg:px-28 items-start gap-3 my-5">
        ...
        <div className="w-full md:w-3/4  ">
          <div className="myshadow bg-white flex items-center">
            <Slider
              {...settings}
              className="custom-slider flex w-full items-center"
            >
              ...
              busData.map((bus) => (
                ...
                >
                      ...
                      <div className="flex items-center mb-6 lg:mb-0">
                        ...
                        <div>
                          <span className="text-lg text-black">
                            {new Date(bus.ArrivalTime).getFullYear()}-
                            {new Date(bus.ArrivalTime).toLocaleDateString(
                              "en",
                              { month: "short" }
                            )}
                            -{new Date(bus.ArrivalTime).getDate()}
                          </span>
                          <span className="text-sm text-gray-500 block">
                            {new Date(bus.ArrivalTime).getHours() <= 9
                              ? `0${new Date(bus.ArrivalTime).getHours()}`
                              : new Date(bus.ArrivalTime).getHours()}
                            :
                            {new Date(bus.ArrivalTime).getMinutes() <= 9
                              ? `0${new Date(bus.ArrivalTime).getMinutes()}`
                  ...
                  <div className="border-t py-2 flex justify-between mt-6">
                    ...
                    <div
                      onClick={() => handelGetSeat(bus.ResultIndex)}
