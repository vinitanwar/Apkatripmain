      ...
      <div className="flex flex-col hidden lg:block custom-color text-white md:px-10 lg:px-52  py-10">
        <div>
          ...
          <div className="tab-content">
            {activeTab === 1 && (
              <>
                <div className="bg-white custom-shadow grid grid-cols-5 gap-0 border-gray-300">
                  <div
                  ...
                  >
                    <p className="text-sm text-[#7E7979] font-medium">Airport Transfer</p>
