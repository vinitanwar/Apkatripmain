        ...
        <div className=" flex justify-center gap-0">
          <div className="  relative ">
            ...
            >
              ...
              <p className="text-black text-xs truncate"></p>
            </div>
          ...
          <div className="relative">
            <div
              className="flex flex-col w-full h-full  px-8 py-3 bg-white  border-r hover:bg-[#ECF5FE] cursor-pointer"
          ...
          <div className="relative">
            <div
              className="flex flex-col   px-8 py-3 bg-white border-r hover:bg-[#ECF5FE]"
