    ...
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between mt-10 items-center border border-[#1882FF] rounded-[15px] bg-white mx-4 md:mx-28 px-4 md:px-10 py-4 ">
        ...
        <div className="md:ml-8 text-center md:text-left">
          <h3 className="text-xl md:text-4xl font-bold">Years of Working</h3>
          <p className="mt-4 text-gray-700">
          ApkaTrip.com stands as India’s largest and most trusted travel brand with a rich history 
          dating back to 2019. Our commitment to excellence has made us a leader in the tourism industry, 
